    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            ...
            <head>
                ...
                <meta name="description" content="Hoàng Minh Quân - Dự án laptopshop" />
                <meta name="author" content="Hoàng Minh Quân" />
                <title>Create User - HMQ</title>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <form:form method="POST" action="/admin/user/create"
                                                ...
                                                <div class="col-md-6">
                                                    <label for="exampleInputPhone" class="form-label">Phone number:
                                                    </label>
